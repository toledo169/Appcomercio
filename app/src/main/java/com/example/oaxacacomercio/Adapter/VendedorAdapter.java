...
public class VendedorAdapter extends RecyclerView.Adapter<VendedorAdapter.VendedorHolder>{
    ...
    public void onBindViewHolder(@NonNull VendedorHolder holder, int position) {
        ...
        holder.txtnombrev.setText("Nombre: " + listavendedor.get(position).getNombrev().toString());
        holder.textapellidos.setText("Apellidos: " + listavendedor.get(position).getApellido_paterno().toString());
    }
