...
public class OrganizacionAdapter extends RecyclerView.Adapter<OrganizacionAdapter.OrganizacionHolder> {
    ...
    public void onBindViewHolder(OrganizacionHolder holder, int position) {
        ...
        holder.txtNombre.setText("Nombre: " + listaorganizaciones.get(position).getNombre().toString());
        holder.txtProfesion.setText("Dirigente: " + listaorganizaciones.get(position).getProfesion().toString());
    }
