...
public class DetallesVendedorAdapter extends RecyclerView.Adapter<DetallesVendedorAdapter.VendedorHolder> {
    ...
    public void onBindViewHolder(@NonNull VendedorHolder holder, int position) {
        ...
        holder.txtnombrev.setText("Nombre: " + listavendedoresdetalle.get(position).getNombrev().toString());
        holder.textapellidos.setText("Apellidos:" + listavendedoresdetalle.get(position).getApellido_paterno().toString());
    }
