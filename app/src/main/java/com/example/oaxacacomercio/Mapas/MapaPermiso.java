    ...
    public void onMapReady(final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                //mapboxMap.addOnMapClickListener(MapaPermiso.this);
              ...
              button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        NavigationLauncherOptions options = NavigationLauncherOptions.builder()
                                ...
                                .build();
                        NavigationLauncher.startNavigation(MapaPermiso.this, options);
                    }
                });
            }
        });
...
/*
   ...
   /* public void trazarrutaubicacion(Double lat, Double longi){
        Point destinationPoint = Point.fromLngLat(Double.parseDouble(longitudinicio),Double.parseDouble(latitud));
